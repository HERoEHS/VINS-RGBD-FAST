...
void CameraPoseVisualization::setLineWidth(double w) { m_line_width = w; }
...
void CameraPoseVisualization::add_pose(const Eigen::Vector3d &p, const Eigen::Quaterniond &q)
{
    ...
    marker.points.push_back(pt_lt);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lb);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lb);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_rb);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_rb);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_rt);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_rt);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lt);  marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lt0); marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lt1); marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lt1); marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lt2); marker.colors.push_back(m_image_boundary_color);
    marker.points.push_back(pt_lt);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_oc);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_lb);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_oc);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_rt);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_oc);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_rb);  marker.colors.push_back(m_optical_center_connector_color);
    marker.points.push_back(pt_oc);  marker.colors.push_back(m_optical_center_connector_color);
